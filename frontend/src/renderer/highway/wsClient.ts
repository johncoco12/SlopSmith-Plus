...
import type { ConnectOptions, SongInfo } from '@/player/types';
import type { ChartState } from '@/player/chartState';
import type { MasteryFilter } from '@/player/masteryFilter';
import type { ProjectionHelper } from '@/player/projection';
